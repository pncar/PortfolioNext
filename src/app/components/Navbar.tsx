...
const Navbar = () => {
  ...
  <div className="flex md:p-6 bg-primary-50 dark:bg-primary-900 md:bg-transparent md:dark:bg-transparent shadow-lg md:shadow-none border-b md:border-b-0 border-primary-600 border-opacity-50">
      <div className="flex flex-row md:flex-col gap-2 w-full py-2 md:py-0 px-2">
        <h3 className="hidden md:block text-sm py-1 2xl:py-4">Categories</h3>
        <ul className="gap-y-0 2xl:gap-y-2 font-medium w-full md:w-auto flex flex-row md:flex-col">
        ...
        <h3 className="hidden md:block text-sm py-1 2xl:py-4">Links</h3>
        <ul className="gap-y-0 2xl:gap-y-2 font-medium w-full md:w-auto flex items-center md:items-start flex-row md:flex-col justify-end md:justify-start">
